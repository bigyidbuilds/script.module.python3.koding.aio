...
AVAILABLE PARAMS:
    ...
    So before creating your list make sure you use xbmcvfs.translatePath()
...
version of Kodi the built-in xbmcvfs.translatePath() function is returning bogus results
...
~"""
    ...
    if not "WindowsApps" in xbmc_install:
        clean = xbmcvfs.translatePath(path)
